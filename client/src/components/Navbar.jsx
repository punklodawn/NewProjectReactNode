        ...
        <Box bg={useColorModeValue('gray.100', 'gray.900')} px={5}>
            <Flex h={16} alignItems='center' justifyContent='space-between'>
                ...
                <HStack>
                    <Link as={ReactLink} to='/'>
                        <Flex allignitems='center'>
                            ...
                            <Text fontWeight='extrabold'>M & L</Text>
                        </Flex>
                    </Link>
                ...
                <Flex alignItems='center'>
                    <NavLink>
                        <Icon as={colorMode === 'light' ? MoonIcon : SunIcon} alignSelf='center' onClick={() => toggleColorMode()}></Icon>
                    </NavLink>

                    <Button as={ReactLink} to='/login' p={2} fontSize='sm' fontWeight={400} variant='link'>Sign In</Button>
                    <Button as={ReactLink} to='/registration' m={2} display={{base: 'none', md:'inline-flex'}} fontSize='sm' fontWeight={600} _hover={{ bg: 'orange.400' }} bg='orange.500' color='white' variant='link'>Sign Up </Button>
            ...
            {isOpen ? (
                <Box pb={4} display={{ md: 'none' }}>
                    <Stack as='nav' spacing={4}>
                        ...
                        <NavLink key='sing up' path='/registration'>Sing Up</NavLink>
                    </Stack>
                </Box>)
                :null}
    </Box>
